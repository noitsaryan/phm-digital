...
function Influencer() {
  ...
  async function onSubmit() {
    await axios.post('/api/sendInfluencerMail', {
  ...
  return (
    <main className='fixed w-screen h-screen top-0 left-0 bg-white z-50 flex items-center justify-center'>
      ...
      <div>
                <h1 className='text-2xl font-bold my-2 text-center' >Influencer Registeration</h1>
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                    <div className="-mx-3 md:flex mb-6 flex-wrap max-w-2xl">
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <input className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="title" type="text" placeholder="https://instagram.com/zayden_lifestyle" onChange={(e) => setDesignation(e.target.value)} />
                        </div>
                        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                            <label className="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="company">
