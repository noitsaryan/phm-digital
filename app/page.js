  ...
  const principles = [
    {
      ...
      description:
        "Understand and align with your client's objectives and KPIs for tailored campaigns.",
    },
    {
      icon: <FaUsers className="mx-1 text-primary" />,
      title: "Influencer Selection Mastery",
      description:
        "Carefully choose influencers who align with the brand and resonate with the target audience.",
    },
    {
      icon: <FaHandshake className="mx-1 text-primary" />,
      title: "Transparency Pioneers",
      description:
        "Ensure influencers transparently disclose their brand relationships to build trust and comply with regulations.",
    },
    {
      icon: <FaCheckCircle className="mx-1 text-primary" />,
      title: "Quality Assurance Excellence",
      description:
        "Review and approve influencer content to maintain the brand's image and message.",
    },
    {
      icon: <FaChartLine className="mx-1 text-primary" />,
      title: "Data-Driven Insights",
      description:
        "Use analytics and reporting tools to measure campaign success and provide data-backed insights for future strategies.",
    },
    {
      icon: <FaDollarSign className="mx-1 text-primary" />,
      title: "Budget Wizards",
      description:
        "Efficiently manage budgets, allocating resources to influencer fees, content creation, and promotion.",
    },
    {
      icon: <FaShieldAlt className="mx-1 text-primary" />,
      title: "Crisis-Ready Approach",
      description:
        "Be prepared to manage unforeseen challenges swiftly and professionally to protect the brand's reputation.",
    },
    {
      icon: <FaHandHoldingHeart className="mx-1 text-primary" />,
      title: "Building Long-Term Partnerships",
      description:
        "Foster enduring relationships with influencers and clients to maintain authenticity in campaigns.",
    },
  ];

  const influencers = [
    "/influencers/IMG_4679.png",
    "/influencers/IMG_4680.PNG",
    "/influencers/IMG_4681.JPG",
    "/influencers/IMG_4682.PNG",
    "/influencers/IMG_4683.PNG",
    "/influencers/IMG_4684.jpg",
    "/influencers/IMG_4685.PNG",
    "/influencers/Snapinsta.app_300824421_630299008454298_6693433050958963756_n_1080.jpg",
    "/influencers/Snapinsta.app_322660407_112769624916751_2073910393885868360_n_1080.jpg",
    "/influencers/Snapinsta.app_356388179_810021517014446_9178031550394306517_n_1080.jpg",
    "/influencers/Snapinsta.app_379952247_213280378205416_197352545132248960_n_1080.jpg",
  ];

  const brands = [
    "/brands/IMG_8198.PNG",
    "/brands/Indrive.PNG",
    "/brands/Lovechild by Masaba.PNG",
    "/brands/MPL.PNG",
    "/brands/MyFitness.PNG",
    "/brands/Stake logo.PNG",
    "/brands/Toothsi.PNG",
  ];
  return (
    <main className="py-24">
      <section className=" flex items-center flex-col justify-center space-y-8 ">
        <div className="flex items-center flex-col justify-center px-8">
          <h1 className=" md:text-4xl text-3xl font-extrabold text-center text-dark">
            Igniting Influence<span className="text-primary">, </span>Amplifying
            Impact<span className="text-primary">.</span>
          </h1>
          <p className="max-w-xl my-4 text-center font-medium">
            We're here to transform your brand's potential into reality. Join us
            in crafting extraordinary brand experiences and igniting influence
        ...
        <div className="md:space-x-4 flex items-center md:space-y-0 space-y-5 justify-center md:flex-row flex-col">
          <button
            ...
            className="bg-primary w-48 text-white px-8 py-2 text-lg font-medium rounded-full"
          >
            Brand
          </button>
          <button
            onClick={() => setInfluencer((prev) => !prev)}
            className="ring-2 ring-inset ring-primary  w-48 text-primary px-8 py-2 text-lg font-medium rounded-full"
          >
            Influencer
          </button>
        </div>
          ...
          <div className="slider space-x-5">
            {influencers.map((e, i) => (
              <Image
                ...
                className=" aspect-square object-cover slider-item rounded-md select-none"
              />
            ))}
          </div>
        </div>
      ...
      <section className="flex flex-col items-center justify-center">
        <h1 className=" md:text-3xl text-2xl font-extrabold text-center text-dark">
          Our 8 Core Practices for Success
        ...
        <div className="grid md:grid-cols-2 gap-4 px-8 py-8 max-w-7xl">
          {principles.map((e, i) => {
            return (
              <div
                key={i}
                className="text-dark border rounded-xl p-4 shadow-md"
              >
            ...
            <div className="space-x-8 flex items-center ">
              {brands.map((e, i) => (
                <Image
                  ...
                  height={150}
                  alt="influencersImages "
                  className=" aspect-video object-contain slider-item rounded-md select-none"
                />
              ))}
            </div>
          </div>
      ...
      <div className="flex items-center flex-col md:flex-row gap-4 mx-5  justify-around shadow-md border max-w-3xl md:mx-auto p-5 rounded-xl">
        <h1 className="md:text-xl text-xl font-extrabold text-center text-dark">
          Don't Hesitate<span className="text-primary">. </span>Join Youthistaan
